...
The `action` ID should be accessible in your backend as an environment variable{/_ unless using Dynamic Actions, in which case you should pass the `action` ID to the backend with the proof and signal _/}.
